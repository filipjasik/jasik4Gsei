...
platno = tkinter.Canvas(okno, width = sirka, heigth = vyska)

pacman_data = tkinter.PhotoImage(file = 'supermario.gif')
pacman = platno.create_image(pac_x * cell_size + cell_size / 2, pac_y * cell_size + cell_size / 2, image = pacman_data)

duch_data = tkinter.PhotoImage(file = 'shrek.gif')
pacman = platno.create_image(duch_x * cell_size + cell_size / 2, duch_y * cell_size + cell_size / 2, image = duch_data)
